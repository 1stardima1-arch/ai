          ...
          <div className="prose-theory mt-8 space-y-6 text-sm leading-relaxed text-(--color-ink-soft)">
            ...
            <section>
              ...
              <ul className="mt-2 list-disc space-y-1.5 pl-5">
                <li>Имя, фотография профиля и email — при входе через Google или VK ID, либо имя — при демо-входе.</li>
            ...
            <section>
              ...
              <ul className="mt-2 list-disc space-y-1.5 pl-5">
                <li>Google / VK — при входе через соответствующий сервис (только для авторизации).</li>
                <li>Хостинг-провайдеру (Vercel) и провайдеру базы данных — для технической работы Сервиса.</li>
